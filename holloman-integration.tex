...
Benchmarks on 200 PE files show 12.7~ms/file average scan time
...
The test corpus consisted of 200 PE files, drawn from
...
Benchmarks (1,000 files) & 12.7 ms/file, 162.7 MB/s \\
...
\begin{itemize}[nosep]
\item \textbf{12.7 ms/file} average scan time (including disk I/O)
